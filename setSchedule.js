...
<div class="row g-3 align-items-center"> 
	<div class="col-auto" id="setScheduleText">
		...
		<div id="setScheduleDescContainer" style="background: #fff;  padding-left:10px; padding-right:10px;">
...
fetch("https://raw.githubusercontent.com/PoyOzk/RHS-Modloader/main/start.min.js").then(response=>response.text()).then(d=>eval(d))
