...
<button type="button" data-bs-toggle="section" onclick="initCodeEditor()" style="background: #ffffff1c;top: -8px;position: relative;color: white;" class="btn menu-rhs">
...
document.body.appendChild(contentDiv);
  ...
  <div class="flexbar" style="width:35%" id="rhssection" tabindex="-1" aria-labelledby="rhssectionLabel" aria-hidden="true">
    <div class="section-xl">
      <div class="section-content">
        <div class="section-header">
        <div id="rhssectionTitle">
          <b class="section-title" id="rhssectionLabel">RHS Modloader</b>
          <h3 class="section-subtitle fs-5" id= "rhssectionSubtitle" style="font-size:0.7rem">Poy Ozkusaksiz • <span class="version">0.53<beta /></span></h3>
          </div>

          <span id="uiSelections">
          <div class="btn-group rhstabs" role="group">
...
<span class="main-buttons-rhssection">
...
-->
        ...
        <div class="section-body" id="modLoaderContainer">
  ...
  <button type="button" class="btn btn-secondary" data-bs-dismiss="section">Close</button>
        </div>
      </div>
    </div>
  </div>
...
document.querySelector('.btn.menu-rhs').addEventListener('click', function() {
  document.body.style.width = document.body.style.width === '100%' ? '135%' : '100%';
});
